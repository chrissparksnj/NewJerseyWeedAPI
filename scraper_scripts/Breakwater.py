...
def extractCardData(html):
    ...
    data_dict['location'] = "Breakwater ATC - Cranbury"
    postData(data_dict)
...
def main():
    for i in range(1, 2):
        print(i)
        url = "https://www.leafly.com/dispensary-info/breakwater-alternative-treatment-center/menu?product_category[]=Flower&page=" + str(i)
        print(url)
        j = requests.get(url)
